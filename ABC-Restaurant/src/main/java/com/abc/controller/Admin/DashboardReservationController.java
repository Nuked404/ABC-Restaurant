 ...
 */
public class DashboardReservationController extends HttpServlet {
    ...
    private String mainFile = "WEB-INF/view/admin/dashboardreservation.jsp";
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DashboardReservationController() {
        super();
