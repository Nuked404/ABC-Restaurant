...
<body>
				...
				<form action="DashboardAccount?action=updateUser" method="post">
					...
					<div class="mb-3">
						<label for="addressLine1" class="form-label">Address Line
							1</label> <input type="text" class="form-control" id="addressLine1"
							name="addressLine1" value="${user.addressLine1}">
					</div>

					<div class="mb-3">
						<label for="addressLine2" class="form-label">Address Line
							2</label> <input type="text" class="form-control" id="addressLine2"
	...
	<div class="container" style="margin-top: 50px; margin-bottom: 50px;">
		<div class="form-container">
			...
			<form action="DashboardAccount?action=updateUserPassword"
				method="post">
				<input type="hidden" name="userID" value="${user.id}" />
				<!-- Password Field -->
				<div class="mb-3">
