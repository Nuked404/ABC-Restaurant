			...
			<div class="col-md-6">
				<div class="card card-login shadow-lg">
					...
					<div class="card-footer text-center">
						Don't have an account? <a href="Register" class="text-primary">Register
							here</a> <br> Go back <a href="index.jsp" class="text-primary">Home</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal fade" id="errorModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">Incorrect email or password. Please
					try again.</div>
