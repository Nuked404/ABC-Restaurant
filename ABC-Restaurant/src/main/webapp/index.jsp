	...
	<div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="images/dining1.jpg" class="d-block w-100"
					alt="Elegant Dining">
			...
			<div class="carousel-item">
				<img src="images/dining2.jpg" class="d-block w-100"
					alt="Gourmet Cuisine">
				<div class="carousel-caption d-none d-md-block">
			...
			<div class="carousel-item">
				<img src="images/dining3.jpg" class="d-block w-100"
				...
				<div class="col-md-6">
					<div class="card shadow-sm">
						...
						<div class="card-body">
							...
							<p class="card-text">Enjoy a luxurious dining experience with
								our carefully curated menu.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="card shadow-sm">
						...
						<div class="card-body">
							...
							<p class="card-text">Order your favorite dishes and get them
		...
		<div class="container">
			<div class="card shadow-sm">
				<div class="row align-items-center">
					...
					<div class="col-md-5">
						<h2>About Us</h2>
						<p>ABC Restaurant is a renowned restaurant chain in Sri Lanka,
							offering a blend of traditional and contemporary cuisine. We
							pride ourselves on providing top-notch service in a warm and
